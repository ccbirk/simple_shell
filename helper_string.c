...
/**
 * str_compare - this compares two str
 * @string1: str one, or the shorter
 * @string2: str two, or the longer
 ...
 * @string1: the str to be concatenated
 * @string2: the str to be concatenated
 *
 * Return: pointer to the array
 */
...
/**
 * str_reverse - this reverses a str.
 *
...
void str_reverse(char *string)
{
	...
	int p = 0, length = str_length(string) - 1;
	char hold;
